  ...
  return (
    <div className='px-4 pt-7'>
        <div className='py-10 font-[Poppins] md:text-center'>
            ...
            <h1 className='uppercase font-bold text-2xl text-[--oxford-blue]'>Checkout our packeges</h1>
            <p className='text-[18px] text-left md:text-center md:px-16 pt-3 text-[--black-coral]'>
